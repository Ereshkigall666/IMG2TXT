...
if __name__ == "__main__":
    ...
    parser.add_argument("-e", "--engine", default="t", help="the OCR engine to use.", choices=[
    ...
    parser.add_argument("-nm", "--no_multiprocess",
    ...
    parser.add_argument("-t_path", "--tesseract_path",
    ...
    parser.add_argument("-k", "--keep_png",
    ...
    img_to_txt(input_dir_path=args.corpus_path, output_type=args.output_format, engine=args.engine, output_dir_path=args.output_dir,
               dpi=args.dpi, multiprocess=(not args.no_multiprocess), nb_core=args.nb_core, force=args.force, tesseract_path=args.tesseract_path, lang=args.lang, keep_png=args.keep_png)
    # print(args)
